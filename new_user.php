			...
			<form action="" id="manage_user">
				...
				<div class="row">
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							<label for="" class="control-label">Apellido/s</label>
						...
						<div class="form-group">
							...
							<select name="type" id="type" class="custom-select custom-select-sm">
								<option value="3" <?php echo isset($type) && $type == 3 ? 'selected' : '' ?>>Alumno</option>
								<option value="2" <?php echo isset($type) && $type == 2 ? 'selected' : '' ?>>Profesor</option>
						...
						<div class="form-group d-flex justify-content-center align-items-center">
							<img src="assets\images\julio.jpg" alt="Avatar" id="cimg" class="img-fluid img-thumbnail ">
						</div>
					</div>
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<small><i><?php echo isset($id) ? "Deja en blanco si no quieres cambiar la contraseña":'' ?></i></small>
						</div>
						<div class="form-group">
