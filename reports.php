            ...
            ?>
              <tr>
                ...
                <td class="project-state">
                  ...
                  } elseif ($stat[$row['status']] == 'Comenzado') {
                    echo "<span class='badge badge-primary'>{$stat[$row['status']]}</span>";
                  } elseif ($stat[$row['status']] == 'En progreso') {
                    echo "<span class='badge badge-info'>{$stat[$row['status']]}</span>";
                  } elseif ($stat[$row['status']] == 'Pausado') {
                    echo "<span class='badge badge-warning'>{$stat[$row['status']]}</span>";
                  } elseif ($stat[$row['status']] == 'Fuera de tiempo') {
...
<script>
  $('#print').click(function() {
    ...
    var _d = "<p class='text-center'><b>Universidad de Guadalajara <br> Centro Universitario de ciencias exactas e ingenierías <br> (<?php echo date("F d, Y") ?>)</b></p>"
    _p.prepend(_d)
    _p.prepend(_h)
